package enderwand.bukkit

import enderwand.bukkit.command.bukkitCommand
import enderwand.bukkit.command.executes
import enderwand.bukkit.command.player
import enderwand.collection.readerOf
import enderwand.collection.toReader
import enderwand.command.argument.double
import enderwand.command.argument.int
import enderwand.command.argument.string
import enderwand.command.executor.execute
import enderwand.command.tabcompleter.tabComplete
